...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav
                class="border-b border-gray-100 bg-gradient-to-r from-white to-[#d79026]"
            >
                        ...
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                                ...
                                <NavLink
                                    ...
                                    :active="route().current('messagerie')"
                                >
                                    Messagerie
                                </NavLink>
                                <NavLink
                                ...
                                <NavLink v-if="$page.props.auth.user.role === 'admin'"
                                    :href="route('AdminGestion')"
                                    :active="route().current('AdminGestion')"
                                >
                                    Gestion Admin
                                </NavLink>
                            </div>
